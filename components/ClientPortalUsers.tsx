...
import {
  UserPlus, Loader2, Check, X, Mail, ShieldOff, ShieldCheck, Copy,
} from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      {usuarios.length === 0 && !showAdd && !criado ? (
        ...
        <div className="space-y-2">
          {usuarios.map(u => (
            <div key={u.uid} className="flex items-center gap-3 bg-white rounded-lg p-3 border border-gray-200">
