...
import {
  ...
  doc, serverTimestamp, Timestamp, getDocs, where
...
const OrcamentoModule: React.FC = () => {
  ...
  const aprovar = async (orc: Orcamento) => {
    ...
    // Pipeline auto-advance: if linked task is in PRE_ORCAMENTO or ORCAMENTO_FINAL, advance to AGENDADO
    if (orc.taskId) {
    ...
    <div className="max-w-5xl mx-auto space-y-5 pb-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Crie e gerencie orçamentos para O.S. e clientes</p>
        </div>
