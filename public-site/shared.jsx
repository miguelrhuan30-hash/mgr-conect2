...
(function() {
  ...
  s.textContent = `
    ...
    @media (max-width: 1100px) {
      ...
      .header-cta-visita { display: none !important; }
      .header-whats-mobile { display: flex !important; }
      .header-logo-img { height: 72px !important; width: auto !important; }
  ...
  return (
    <div style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(13,59,94,0.97)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(255,255,255,0.10)', boxShadow: '0 4px 24px rgba(0,0,0,0.18)' }}>
      <div className="header-inner" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 56px', fontFamily: MGR.sans, gap: 24, position: 'relative' }}>
        ...
        {/* DIREITA — CTAs desktop + ícone WhatsApp mobile */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
          ...
          <a href={MGR_WHATS} target="_blank" rel="noopener" className="header-cta-visita" style={{ background: MGR.acento, color: '#fff', padding: '11px 20px', fontSize: 13.5, fontWeight: 600, fontFamily: MGR.sans, borderRadius: 8, display: 'inline-flex', alignItems: 'center', gap: 8, letterSpacing: 0.2 }}>
            Visita de Valor
            <Ico name="arrow" size={14} />
          </a>
          {/* Ícone WhatsApp — aparece apenas em mobile no lugar dos CTAs */}
          <a href={MGR_WHATS} target="_blank" rel="noopener" className="header-whats-mobile"
            aria-label="Falar no WhatsApp"
            style={{ background: '#25D366', color: '#fff', width: 42, height: 42, borderRadius: 8, display: 'none', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
